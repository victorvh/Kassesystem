...
If you want to view previous purchases you can press "Se køb" in the bottom left corner and you will be met with the page in the picture below. For now, I only show the total price and the UUID for each purchase because it became too cluttered to the list of items bought.
